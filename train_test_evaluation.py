...
from model.load_param_data         import  load_dataset, load_param,load_dataset_with_augmentation

# model

from model.model_res_Unet          import  res_UNet
from model.swintransformer         import  SwinTransformerSys
...
class Trainer(object):
    def __init__(self, args):
        ...
        # self.train_img_ids, self.val_img_ids, self.test_txt = load_dataset_with_augmentation(args.root, args.dataset, args.split_method)
        self.train_img_ids, self.val_img_ids, self.test_txt, _ = load_dataset_with_augmentation(args.root, args.dataset,
                                                                                                args.split_method)
        ...
        if args.model == 'SwinTransformerSys':
            model       = SwinTransformerSys(in_chans=args.in_channels)
